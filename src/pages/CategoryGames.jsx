...
function CategoryGames() {
  ...
  const fetchByGenre = async () => {
    try {
      ...
      const filtered = res.data.filter(
        (g) => g.esGlobal && g.genero.toLowerCase() === genre.toLowerCase()
      );
  ...
  const hasActiveFilters = () => {
    return filters.plataforma || filters.año || 
  ...
  if (loading) {
    return (
      <div className="loading-container">
        ...
        <p className="loading-text">Cargando juegos de {genre}...</p>
      </div>
    );
  }
      ...
      <div className="category-page">
        <div className="container">
          ...
          <div className="page-header">
            <h1 className="page-title">🎮 Juegos de {genre}</h1>
            <p className="page-subtitle">
              Explora los títulos más destacados de la categoría {genre}
            </p>
          </div>
                ...
                <div className="empty-state">
                  ...
                  <p>
                    {hasActiveFilters() 
                      ...
                      : "Pronto añadiremos más títulos en esta categoría"}
                  </p>
                </div>
              ) : (
                <>
